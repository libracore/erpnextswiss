                ...
                if match_payment_entry:
                    ...
                    if credit_debit == "DBIT":
                        ...
                        possible_sinvs = frappe.get_all("Sales Invoice", 
                            ...
                            fields=['name', 'customer', 'customer_name', 'outstanding_amount', 'esr_reference', 'reference_number_full'])
                        if possible_sinvs:
                            invoice_matches = []
                            for sinv in possible_sinvs:
                                is_match = False
                                if sinv['name'] in transaction_reference or ('reference_number_full' in sinv and sinv['reference_number_full'] and sinv['reference_number_full'] == transaction_reference) or ('esr_reference' in sinv and sinv['esr_reference'] and sinv['esr_reference'] == transaction_reference):
