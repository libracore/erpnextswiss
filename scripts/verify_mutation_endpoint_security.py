...
REQUIRED_POST = {
    ...
    "page/payment_export/payment_export.py:generate_payment_file_for_mcp",
    ...
    "doctype/payment_proposal/payment_proposal.py:create_payment_proposal_bank_file_for_mcp",
    "doctype/payment_proposal/payment_proposal.py:create_payment_proposal_for_mcp",
    "doctype/payment_proposal/payment_proposal.py:cancel_payment_proposal_for_mcp",
    "doctype/payment_proposal/payment_proposal.py:release_from_payment_proposal",
    "doctype/payment_proposal/payment_proposal.py:set_supplier_payment_details_for_mcp",
